...
First off, if you haven't already, you'll need to sign a safety waiver, which basically just says that, if you do something dumb and get hurt, you won't sue us.

Second, every new visitor is required to take our Culture Quiz, which just establishes some expectations for how you conduct yourself in the lab. The link to that is here:

oushoptraining.com/fabLab/CultureQuiz

Finally, you'll need to take the certification for whatever tool(s) you intend to use. You can see the full list of those here:

oushoptraining.com/fabLab

Once you've taken care of all three of these things, you're good to go! Let us know if you have any questions or problems, either by talking to a staff member in the shop, or emailing us at fablab@ou.edu`)
                    } catch (e) {
                        return rej(err)
                    }
                }
